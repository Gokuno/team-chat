...
export const PreferencesModal = ({
    ...
    const handleRemove = async () => {
        ...
        removeWorkspace({
            ...
            onError: () => {
                toast.error("Fallo la eliminacion");
            }
        })
    }
    ...
    const handleEdit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        updateWorkspace({
            ...
            onError: () => {
                toast.error("Fallo en la actualizacion");
            }
        })
    };
                    ...
                    <div className="px-4 pb-4 flex flex-col gap-y-2">
                        <Dialog open={editOpen} onOpenChange={setEditOpen} >
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    <DialogTitle>
                                        Renombrar este espacio de trabajo
                                    </DialogTitle>
                                </DialogHeader>
                        ...
                        >
                            ...
                            <p className="text-sm font-semibold">Eliminar espacio de trabajo</p>
                        </button>
                    </div>
                </DialogContent>
            </Dialog>
